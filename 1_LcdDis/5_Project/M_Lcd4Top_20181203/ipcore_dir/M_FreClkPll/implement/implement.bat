...
xst -ifn xst.scr
move M_FreClkPll_exdes.ngc results\

REM  Copy the constraints files generated by Coregen
echo 'Copying files from constraints directory to results directory'
copy ..\example_design\M_FreClkPll_exdes.ucf results\

cd results

echo 'Running ngdbuild'
ngdbuild -uc M_FreClkPll_exdes.ucf M_FreClkPll_exdes

echo 'Running map'
map -timing -pr b M_FreClkPll_exdes -o mapped.ncd
...
netgen -ofmt vhdl -sim -tm M_FreClkPll_exdes -w routed.ncd routed.vhd
cd ..

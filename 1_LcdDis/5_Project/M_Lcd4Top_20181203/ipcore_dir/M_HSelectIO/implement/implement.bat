...
xst -ifn xst.scr
move M_HSelectIO_exdes.ngc results\

REM  Copy the constraints files generated by Coregen
echo 'Copying files from constraints directory to results directory'
copy ..\example_design\M_HSelectIO_exdes.ucf results\

cd results

echo 'Running ngdbuild'
ngdbuild -uc M_HSelectIO_exdes.ucf M_HSelectIO_exdes

echo 'Running map'
map -timing M_HSelectIO_exdes -o mapped.ncd
...
netgen -ofmt vhdl -sim -tm M_HSelectIO_exdes -w routed.ncd routed.vhd
cd ..

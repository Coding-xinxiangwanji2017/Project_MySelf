...
xst -ifn xst.scr
move M_LSelectIO_exdes.ngc results\

REM  Copy the constraints files generated by Coregen
echo 'Copying files from constraints directory to results directory'
copy ..\example_design\M_LSelectIO_exdes.ucf results\

cd results

echo 'Running ngdbuild'
ngdbuild -uc M_LSelectIO_exdes.ucf M_LSelectIO_exdes

echo 'Running map'
map -timing M_LSelectIO_exdes -o mapped.ncd
...
netgen -ofmt vhdl -sim -tm M_LSelectIO_exdes -w routed.ncd routed.vhd
cd ..

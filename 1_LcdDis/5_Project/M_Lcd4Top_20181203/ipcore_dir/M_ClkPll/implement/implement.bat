...
xst -ifn xst.scr
move M_ClkPll_exdes.ngc results\

REM  Copy the constraints files generated by Coregen
echo 'Copying files from constraints directory to results directory'
copy ..\example_design\M_ClkPll_exdes.ucf results\

cd results

echo 'Running ngdbuild'
ngdbuild -uc M_ClkPll_exdes.ucf M_ClkPll_exdes

echo 'Running map'
map -timing -pr b M_ClkPll_exdes -o mapped.ncd
...
netgen -ofmt vhdl -sim -tm M_ClkPll_exdes -w routed.ncd routed.vhd
cd ..
